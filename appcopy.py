...
def interaction_1():
    ...
    # Unpack the three return values
        caption, story, classification = runModels(upld_path)

        # Pass all three results to the HTML template
        return render_template('milestone1.html', active='interaction_1', imgPath=img_path, story=story, caption=caption, classification=classification)
